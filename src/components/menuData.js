        ...
        topics: [
          {
            ...
            key: 'topic01',
            subtopics: [
              { name: 'Один, два, три... Первый, второй, третий', path: '/math1/topic91/subtopic1' },
              { name: 'Вверху. Внизу. Слева. Справа', path: '/math1/topic91/subtopic2' },
              { name: 'Раньше. Позже. Сначала. Потом', path: '/math1/topic91/subtopic3' },
              { name: 'Столько же. Больше. Меньше', path: '/math1/topic91/subtopic4' },
              { name: 'На сколько больше? На сколько меньше?', path: '/math1/topic91/subtopic5' },
              { name: 'Странички для любознательных', path: '/math1/topic91/subtopic6' },
          ...
          },
          {
            ...
            key: 'topic02',
            subtopics: [
              { name: 'Знаки действия', path: '/math1/topic02/subtopic4' },
              { name: 'Длиннее, короче, одинаковые по длине', path: '/math1/topic02/subtopic6' },
              { name: 'Странички для любознательных', path: '/math1/topic02/subtopic8' },
              { name: 'Точка. Кривая линия. Прямая линия.', path: '/math1/topic02/subtopic9' },
              { name: 'Отрезок. Луч', path: '/math1/topic02/subtopic10' },
              { name: 'Ломаная линия', path: '/math1/topic02/subtopic11' },
              { name: 'Знаки сравнения', path: '/math1/topic02/subtopic12' },
              { name: 'Равенство. Неравенство', path: '/math1/topic02/subtopic13' },
              { name: 'Многоугольник. Круг', path: '/math1/topic02/subtopic14' },
              { name: 'Куб. Шар', path: '/math1/topic02/subtopic18' },
              { name: 'Проектные задания', path: '/math1/topic02/subtopic21' },
              { name: 'Сантиметр', path: '/math1/topic02/subtopic22' },
              { name: 'Странички для любознательных', path: '/math1/topic02/subtopic25' },
              { name: 'Что узнали. Чему научились', path: '/math1/topic02/subtopic26' },
            ],
          },
          {
